...
export async function addStudents(req, res){
    ...
    if(error){
        ...
        return res.status(400).send({errors: error. errorlist});
    }
    ...
    try{
        ...
        return res.status(400).json({detail: "Something went worng"});
    }
}
...
export async function updateStudent(req, res){
    ...
    try{
        ...
        return res.status(500).json({ detail: "Something went horribly wrong!!!!"})
    }
}